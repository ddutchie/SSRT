...
public class SSRT : MonoBehaviour
{
    ...
    void UpdateVariables()
    {
        ...
        if (cameraSize != renderResolution / (float)resolutionDownscale)
        {
            ...
            if(cam.stereoEnabled) ssrtMrt[0].vrUsage = VRTextureUsage.TwoEyes;
            ...
            if(cam.stereoEnabled) ssrtMrt[1].vrUsage = VRTextureUsage.TwoEyes;
            ...
            if(cam.stereoEnabled) previousFrameTexture.vrUsage = VRTextureUsage.TwoEyes;
           ...
           if(cam.stereoEnabled)  previousDepthTexture.vrUsage = VRTextureUsage.TwoEyes;
